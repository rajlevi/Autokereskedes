...
namespace Autoker
{
    ...
    public partial class cnAutoker : DbContext
    {
        ...
        private void KereskedesMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kereskedes>().Property(x => x.KereskedesId).HasColumnName(@"KereskedesId").IsRequired().ValueGeneratedNever();
        ...
        private void AutoMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Auto>().Property(x => x.KereskedesId).HasColumnName(@"KereskedesId").ValueGeneratedNever();
        ...
        private void EladoMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Elado>().Property(x => x.KereskedesId).HasColumnName(@"KereskedesId").ValueGeneratedNever();
            modelBuilder.Entity<Elado>().Property(x => x.Admin).HasColumnName(@"Admin").IsRequired().ValueGeneratedNever();
        ...
        {
            modelBuilder.Entity<Kereskedes>().HasMany(x => x.Autos).WithOne(op => op.Kereskedes1).HasForeignKey(@"KereskedesId").IsRequired(true);
            modelBuilder.Entity<Kereskedes>().HasMany(x => x.Elados).WithOne(op => op.Kereskedes1).HasForeignKey(@"KereskedesId").IsRequired(true);

            modelBuilder.Entity<Cim>().HasOne(x => x.Kereskedes).WithOne(op => op.Cim).HasForeignKey(typeof(Kereskedes), @"CimId").IsRequired(false);

            modelBuilder.Entity<Auto>().HasOne(x => x.Kereskedes1).WithMany(op => op.Autos).HasForeignKey(@"KereskedesId").IsRequired(true);

            modelBuilder.Entity<Elado>().HasOne(x => x.Kereskedes1).WithMany(op => op.Elados).HasForeignKey(@"KereskedesId").IsRequired(true);
        }
