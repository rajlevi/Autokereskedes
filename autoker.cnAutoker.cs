...
namespace Autoker
{
    ...
    public partial class cnAutoker : DbContext
    {
        ...
        public virtual DbSet<Auto> Autos
        {
            get;
            set;
        }

        public virtual DbSet<Elado> Elados
        {
            get;
            set;
        }
        ...
        {
            modelBuilder.Entity<Kereskedes>().ToTable(@"Kereskedes");
            modelBuilder.Entity<Kereskedes>().Property(x => x.KereskedesId).HasColumnName(@"KereskedesId").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
        ...
        {
            modelBuilder.Entity<Cim>().ToTable(@"Cims");
            modelBuilder.Entity<Cim>().Property(x => x.CimId).HasColumnName(@"CimId").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
        ...
        private void AutoMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Auto>().Property(x => x.AutoId).HasColumnName(@"AutoId").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
        ...
        {
            modelBuilder.Entity<Elado>().ToTable(@"Elados");
            modelBuilder.Entity<Elado>().Property(x => x.EladoId).HasColumnName(@"EladoId").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
        ...
        {
            modelBuilder.Entity<Kereskedes>().HasMany(x => x.Autos).WithOne(op => op.Kereskedes1).HasPrincipalKey(@"AutoId").HasForeignKey(@"AutoId").IsRequired(true).OnDelete(DeleteBehavior.Restrict); ;
            modelBuilder.Entity<Kereskedes>().HasMany(x => x.Elados).WithOne(op => op.Kereskedes1).HasPrincipalKey(@"EladoId").HasForeignKey(@"EladoId").IsRequired(true).OnDelete(DeleteBehavior.Restrict); ;

            modelBuilder.Entity<Cim>().HasOne(x => x.Kereskedes).WithOne(op => op.Cim).HasForeignKey(typeof(Kereskedes), @"CimId").IsRequired(false).OnDelete(DeleteBehavior.Restrict); ;

            modelBuilder.Entity<Auto>().HasOne(x => x.Kereskedes1).WithMany(op => op.Autos).HasPrincipalKey(@"AutoId").HasForeignKey(@"AutoId").IsRequired(true).OnDelete(DeleteBehavior.Restrict); ;

            modelBuilder.Entity<Elado>().HasOne(x => x.Kereskedes1).WithMany(op => op.Elados).HasPrincipalKey(@"EladoId").HasForeignKey(@"EladoId").IsRequired(true).OnDelete(DeleteBehavior.Restrict); ;
        }
